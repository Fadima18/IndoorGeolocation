...
class TestViews(TestCase):
    def setUp(self):
        ...
        self.analytics_template = "indoorGeolocation/analytics.html"
    ...
    def testViewRoomAnalyticsShouldReturnAnalyticsPage(self):
        ...
        Position.objects.create(
            x=room_coordinates[0], y=room_coordinates[1], device=self.device)

        response = self.client.post(self.analytics_url, {'room': room})

        self.assertEquals(response.status_code, 200)
        self.assertTemplateUsed(self.analytics_template)
